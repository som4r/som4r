...
setcookie("mod_googlemapv3js_token", "default");
...
<script>
    ...
    function ajax_get_authentication() {
        jQuery.get("<?php echo JURI::base() . 'modules/mod_tts/call_authentication.php'; ?>",
            function(data) {
                ...
                setCookie("mod_googlemapv3js_token",data);
            }
        );
    }
    ...
    function gps_ajax_call_wsrest() {
        ...
        var token=getCookie("mod_googlemapv3js_token");
        jQuery.post("<?php echo JURI::base() . 'modules/mod_googlemapv3js/call_wsrest_gps.php'; ?>",
            {"token":token},
            function(data) {
